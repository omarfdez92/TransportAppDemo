...
public class RiderActivity extends FragmentActivity implements OnMapReadyCallback {
                                    ...
                                    if (lastKnownLocation != null) {
                                        ...
                                        if (distanceInKilometers < 0.01) {
                                            ...
                                            handler.postDelayed(new Runnable() {
                                                @Override
                                                public void run() {
                                                    //method that we can run in the time we write

                                                    infoTextView.setText("");
                                                    callCarpoolButton.setVisibility(View.INVISIBLE);
                                            ...
                                            infoTextView.setText("Your driver " + distanceOneDP.toString() + " kilometers away!");
    ...
    public void updateMap(Location location) {
        ...
        if (driverActive != false) {
            ...
            mMap.addMarker(new MarkerOptions().position(userLocation).title("Your Here"));
